...
%uncopt = optimoptions('fminunc','Algorithm','quasi-newton', 'MaxIter', 5000, 'Display', 'none');
...
if fitSigma
    ...
    %[x, val, exitflag] = fminunc(LL2, [mu0, bg0, N0, sigma0], uncopt);
    ...
    %[x, val, exitflag] = fminunc(LL2, [mu0, bg0, N0], uncopt); % 
end
