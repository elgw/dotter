...
gui.r2 = uicontrol('Style', 'Radiobutton', ...
    ...
    'TooltipString', sprintf('Use this option of you already have\n a calc folder and want to keep the segmentation\n but overwrite the dots'));
...
uicontrol( ...
    'Style', 'text', ...
    'String', 'Mask dilation [pixels]', ...
    'Units', 'Normalized', ...
    'Position', [.05, .2, .40, .1], ...        
    'Parent', gui.qsegPanel);
...
uicontrol('Style', 'text', ...
    ...
    'Position', [.1,.45,.4,.1], ...
    'Parent', gui.dotPanel, ...
    'TooltipString', sprintf('The number of dots to store per FOV, mainly to reduce file size.\nDon''t set lower than the default unless you know what you are doing'));
